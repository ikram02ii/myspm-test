...
import { isDiagramDeixisAnswer } from "../shared/gradingEvidencePolicy";
import { studentAnswerExplicitlySupportsMarkPoint } from "../shared/gradingEvidencePolicy";
 ...
 */
export function studentAnswerContainsDistinctiveRubricToken(
  studentAnswer: string,
  rubricIdea: string,
