...
/** Practice app: MCQ "Ask AI" sends only Aâ€“D and maxScore 1 â€” steer feedback to compare wrong vs correct options. */
...
async function gradeWithQwen(params: {
  ...
  const gradingRules = [
    ...
    "- 5) Write feedback from matched + missing concepts only â€” brief, student-friendly.",
    "- 6) Write modelAnswer at EXACTLY SPM Form 4/5 level â€” not A-Level, not university, not advanced.",
    "     Use only vocabulary and depth found in Malaysian SPM textbooks. Short sentences. Simple school words.",
    "     Match the mark allocation: 1 mark = 1 short point. Do NOT pad with extra advanced detail.",
    "     Write what a student would write in the exam â€” not a teacher explanation or textbook paragraph.",
    "     NEVER require students to copy it verbatim â€” it is a concept reference, not the only correct wording.",
    ...
    "FEEDBACK STYLE (supportive SPM teacher â€” easy for students to read):",
    ...
    "- Length: 1â€“3 short sentences. No paragraphs, no padding.",
    ...
    "modelAnswer rules:",
    "- Reference only â€” lists valid concepts an examiner expects; students need not match this wording.",
    ...
    "- For full marks, modelAnswer can be a single short line confirming the same key concepts.",
  ]
